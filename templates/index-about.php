          ...
          <div class="swiper-wrapper">
            <?php foreach ( $steps_list as $step ) : ?>
              <div class="step swiper-slide">
                <img src="./assets/img/icons/steps-<?php echo $step['icon'] ?>.svg" alt="<?php echo $step['title'] ?>" class="step__icon">
                <h4 class="step__title"><?php echo $step['title'] ?></h4>
            ...
            <?php foreach ( $team as $member) : ?>
              <div class="member swiper-slide">
                <picture class="member__pic">
                  <source srcset="<?php echo $member['photo'] ?>.webp" type="image/webp">
                  <img src="<?php echo $member['photo'] ?>.jpg" alt="<?php echo $member['name'] ?> photo" class="member__img">
                </picture>

                <h4 class="member__name"><?php echo $member['name'] ?></h4>
                <p class="member__position"><?php echo $member['position'] ?></p>
              </div>
            <?php endforeach ?>
          </div>
        </div>
